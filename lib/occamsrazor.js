  ...
  */
  ...
  function stick () {
    ...
    if (!consumeAdapters.length) {
      if (options.eventComparator) {
        ut.bynaryInsert(_events, { context: this, args: args }, options.eventComparator)
      } else {
  ...
  function proxy (id) {
    ...
    return occamsrazor({ _adapters: _adapters, _events: _events, _ns: id, eventComparator: options.eventComparator })
  }
